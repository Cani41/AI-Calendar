...
export default function Home() {
  ...
  return (
    <main className="relative min-h-dvh w-full overflow-y-auto">
      ...
      <div
        className="relative z-10 min-h-dvh w-full flex items-center justify-center px-6"
        style={{
          ...
          >
            ...
            <a
              ...
              className={`group lift relative w-full inline-flex items-center justify-center gap-2.5 h-[52px] rounded-full px-6 text-[15px] font-medium tracking-tight
                ...
                ${loading ? "opacity-85 cursor-wait" : "hover:opacity-90"}
                shadow-[0_1px_2px_rgba(0,0,0,0.08),0_8px_24px_-8px_rgba(0,0,0,0.25)]
                dark:shadow-[0_1px_2px_rgba(0,0,0,0.5),0_10px_28px_-8px_rgba(0,0,0,0.55)]
              ...
              {loading ? (
                <>
                  <span className="flex gap-[5px] items-center">
                    ...
                    <span className="dot" style={{ background: "currentColor", opacity: 0.8, animationDelay: "150ms" }} />
                    <span className="dot" style={{ background: "currentColor", opacity: 0.8, animationDelay: "300ms" }} />
                  </span>
